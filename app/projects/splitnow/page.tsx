          ...
          >
            <Card className="bg-white/5 border-white/10 overflow-hidden">
              <CardContent className="p-0">
                <div className="aspect-[4/3] bg-gradient-to-br from-cyan-500/20 to-blue-500/20 flex items-center justify-center relative overflow-hidden">
                  <Image
            ...
            >
              <motion.a
                href="https://github.com/Prakharsahu10/SplitNow"
                target="_blank"
              ...
              <motion.a
                href="https://splitnow-three.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
